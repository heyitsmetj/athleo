...
public class TrainerDashboardFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_trainer_dashboard, container, false);
    ...
    private void setupWebView() {
        ...
        webView.loadUrl("file:///android_asset/stitch/trainer_dashboard_dark_3/code.html");
    }
